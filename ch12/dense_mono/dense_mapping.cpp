...
* 請注意本程序並不完美，你完全可以改進它——我其實在故意暴露一些問題(這是藉口)。
***********************************************/
...
int main(int argc, char **argv) {
    ...
    for (int index = 1; index < color_image_files.size(); index++) {
        ...
        SE3d pose_T_C_R = pose_curr_TWC.inverse() * pose_ref_TWC;   // 座標轉換關係： T_C_W * T_W_R = T_C_R
