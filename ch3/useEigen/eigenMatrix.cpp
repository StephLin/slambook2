...
int main(int argc, char **argv) {
  // Eigen 中所有向量和矩陣都是Eigen::Matrix，它是一個模板類。它的前三個參數爲：數據類型，行，列
  // 聲明一個2*3的float矩陣
  ...
  Matrix3d matrix_33 = Matrix3d::Zero(); //初始化爲零
  ...
  // 但是在Eigen裏你不能混合兩種不同類型的矩陣，像這樣是錯的
